...
if __name__ == "__main__":
    ...
    with get_session() as session:
        ...
        user1_income_list = generate_transactions(50, user1, (50,150), "INCOME", date_range, (1,3))
        user1_expense_list = generate_transactions(50, user1, (50,150), "EXPENSE", date_range, (4, 6))
        user2_income_list = generate_transactions(50, user2, (50,150), "INCOME", date_range, (1, 3))
        user2_expense_list = generate_transactions(50, user2, (50,150), "EXPENSE", date_range, (4, 6))
        user3_income_list = generate_transactions(50, user3, (50,150), "INCOME", date_range, (1, 3))
        user3_expense_list = generate_transactions(50, user3, (50,150), "EXPENSE", date_range, (4, 6))
        user4_income_list = generate_transactions(50, user4, (50,150), "INCOME", date_range, (1, 3))
        user4_expense_list = generate_transactions(50, user4, (50,150), "EXPENSE", date_range, (4, 6))
        user5_income_list = generate_transactions(50, user5, (50,150), "INCOME", date_range, (1, 3))
        user5_expense_list = generate_transactions(50, user5, (50,150), "EXPENSE", date_range, (4, 6))
